	...
	<section id="primary">
		<div id="content" role="main">
			...
			<?php
				...
				echo '<div class="heroContainer interior issues" style="background-image:url(\'https://s3.amazonaws.com/rahm-chicago-production/hero/'.$category->slug.'.jpg\')"><div class="gradient"></div><div class="row"><div class="small-12 columns">';
